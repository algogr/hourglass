...
**
** Created: Wed May 2 22:27:23 2012
...
const QMetaObject invoice_customer::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_invoice_customer,
      qt_meta_data_invoice_customer, 0 }
};
...
int invoice_customer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: check_clicked(); break;
        case 1: date_from(); break;
        case 2: date_to(); break;
        case 3: editor_changed((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< const QModelIndex(*)>(_a[2]))); break;
        case 4: editor_spin_changed((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QModelIndex(*)>(_a[2]))); break;
        case 5: create_invoice(); break;
        default: ;
        }
        _id -= 6;
    }
