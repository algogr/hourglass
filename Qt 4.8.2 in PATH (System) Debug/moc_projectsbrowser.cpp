...
**
** Created: Tue Jul 2 11:49:29 2013
...
void ProjectsBrowser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData ProjectsBrowser::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ProjectsBrowser::staticMetaObject = {
    { &GeneralBrowser::staticMetaObject, qt_meta_stringdata_ProjectsBrowser,
      qt_meta_data_ProjectsBrowser, &staticMetaObjectExtraData }
};
